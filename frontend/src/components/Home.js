...
const Home = () => {
  ...
  return (
    <div className="position-relative" style= {{ backgroundColor: "black" }}>
        ...
        src="/bg.jpg" alt="Smoke in the air" />
      ...
      <div className="container mt-3 text-white" style= {{ backgroundColor: "black" }}>
        ...
        <p>Nesse sistema, qualquer usuário pode fazer um relato de um incêndio que ele tenha visto, fornecendo informações para que as autoridades mais próximas possam atuar para combater o incêndio e reduzir os danos causados.</p>      
      </div>
    </div>
  );
};
